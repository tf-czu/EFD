...
#Added code
def elliptic_fourier_descriptors2( sortedCnt, N ):
    
    deltaXY_list = deltaX_deltaY( sortedCnt )
...
def deltaX_deltaY( contours_list, bin_img = None ):
    if bin_img:
...
def elliptic_fourier_descriptors(bin_im,N):
    ...
    deltaXY_list = deltaX_deltaY(bin_im.copy())
